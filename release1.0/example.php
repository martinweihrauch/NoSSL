...
<body>
	  <div id="content">
				<h1>NoSSL Demo</h1>
				<p>NoSSL is a software &copy; by Smart In Media 2014</p>
				<p>For private use free under GPL-license Version 3.0</p>
				<p>For commercial use, please inquire at <a href="http://www.nossl.net">www.NoSSL.net</a></p>
				<!-- <h2><small>Example by <a href="http://www.smartinmedia.com">Smart In Media</a></small></h2> -->
	
          <div class="formdiv">
			<form action="example.php" class="testclass andanother" onsubmit="return CheckInput();" method="post">
